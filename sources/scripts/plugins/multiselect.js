...
(function(root, factory) {
    ...
    $.extend(Fastselect.prototype, {
        ...
        setupSingleElement: function(onDone) {
            ...
            this.$queryInput = $('<input>').attr('placeholder', this.options.searchPlaceholder).attr('readonly', 'readonly').addClass(this.options.queryInputClass).appendTo(this.$controls);
        ...
        setupMultipleElement: function(onDone) {
            ...
            this.$queryInput = $('<input>').attr('readonly', 'readonly').addClass(options.queryInputClass).appendTo(this.$controls);
        ...
        addChoiceItem: function(optionModel) {
            ...
            $(
                '<div data-text="' + optionModel.text + '" data-value="' + optionModel.value + '" class="' + this.options.choiceItemClass + '">' +
                    ...
                    '<button class="' + this.options.choiceRemoveClass + '" type="button"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button>' +
                '</div>'
